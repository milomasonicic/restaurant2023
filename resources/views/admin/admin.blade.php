...
<x-app-layout>
    ...
    <div class="w-2/4 mx-auto" id="createDiv">  
            ...
            <form action="{{route("item.store")}}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg">
                <div class="w-3/4 my-8 mx-auto flex flex-col">
                    ...
                    <div class="mt-5" >
                        <input type="file" class="form-control" name="photo" id="imageUploadDiv" />
                    </div>
    
                        <button type="submit" style="background-color: #0080F6; color:azure;" class=" mt-16 mr-4 font-semibold py-3 px-6 rounded shadow mb-12">Add</button>
